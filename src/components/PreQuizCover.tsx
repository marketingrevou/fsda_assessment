...
interface PreQuizCoverProps {
  onBack: () => void;
  onNext: () => void;
}

const PreQuizCover: React.FC<PreQuizCoverProps> = ({ onBack, onNext }) => {
  return (
    <div className="h-screen w-full flex flex-col bg-white relative overflow-hidden">
      ...
      <div className="flex-grow w-full max-w-md mx-auto flex flex-col items-center justify-center text-center p-4">
        ...
        <div className="w-full max-w-[240px] sm:max-w-[280px] aspect-square relative mb-2">
          <Image
            src="/prequiz_cover.png"
            alt="Data Analyst Quiz"
            fill
            className="object-contain"
            priority
          />
        ...
        <p className="text-gray-700 text-sm sm:text-base px-4">
          Sebelum mulai, kita akan belajar bersama dulu tentang tools dasar Data Analyst. Disini kamu akan di bantu untuk menjawab, jadi tidak perlu takut menjawab!
        </p>
      </div>
