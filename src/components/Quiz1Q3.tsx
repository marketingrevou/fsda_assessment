    ...
    options: [
      {
        id: "a",
        label: "a.",
        description: "Hanya kesimpulan I yang benar",
      },
      {
        id: "b",
        label: "b.",
        description: "Hanya kesimpulan II yang benar",
      },
      {
        id: "c",
        label: "c.",
      ...
      },
      {
        id: "d",
        label: "d.",
        description: "Kesimpulan I dan II tidak benar",
      }
    ],
  },
];

interface Quiz1Q3Props {
  onBack: () => void;
  onComplete: () => void;
  onAnswer: (questionId: string, selectedOptions: string[]) => void;
}

const Quiz1Q3: React.FC<Quiz1Q3Props> = ({ onBack, onComplete, onAnswer }) => {
